...
class MainMenu(BetterCMD):
	...
	def do_portfwd(self, line):
		...
		Examples:
			...
			-> 192.168.179.1:80		Forward the localhost:80 to 192.168.179.1:80
			0.0.0.0:8080 -> 192.168.179.1:80	Forward the 0.0.0.0:8080 to 192.168.179.1:80
		"""
		if not line:
